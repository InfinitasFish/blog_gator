...
RETURNING id, created_at, updated_at, feed_name, feed_url, user_id, last_fetched_at
`
...
SELECT id, created_at, updated_at, feed_name, feed_url, user_id, last_fetched_at from feeds
